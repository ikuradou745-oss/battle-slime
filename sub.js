            ...
            if (typeof DEMO_PROFILES !== 'undefined') {
                DEMO_PROFILES.forEach(demo => {
                    ...
                    btn.addEventListener('click', () => {
                        tempProfileData = [...demo.profileData];
                        const gridChildren = document.getElementById('profile-grid').children;
                        for(let i = 0; i < 196; i++) {
                            gridChildren[i].style.backgroundColor = tempProfileData[i];
                        }
                    });
